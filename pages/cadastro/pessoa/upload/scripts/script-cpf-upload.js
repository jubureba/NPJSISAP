$(document).ready(function (e) {
    ...
    $("#uploadForm1").on('submit', (function (e) {
        e.preventDefault();
        $.ajax({
            url: "pages/cadastro/pessoa/upload/php-img-upload/upload-img.php",
            type: "POST",
    ...
    $(function () { //FUNÇÃO PARA TRATAR A IMAGEM
        $("#upload-cpf").change(function () {
            ...
            if (!((imagefile == match[0]) || (imagefile == match[1]) || (imagefile == match[2]))) {
                $('#previewing1').attr('src', 'dist/img/defaultimg.gif');
                return false;
            }
            else {
