        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary" style="overflow: auto; height: 620px">
                        <div class="box-header">
                            <h3 class="box-title">Assistido - Informações</h3><hr>
                        ...
                        echo " O Nome é: ". $_GET['nome']. "<br/>E o id atendimento defensoria é: " .$_GET['id'];
                ...
                <div class="col-md-6">
                    <div class="box box-primary" style="overflow: auto; height: 620px">
                        <div class="box-header">
                            <h3 class="box-title">Requerido - Informações</h3><hr>
