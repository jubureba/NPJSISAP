...
(function (Ea, Q, k) {
    var P = function (h) {
        ...
        function ob(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures, g = '<input id="pesq_tab_npj" type="search" placeholder="Pesquisar"  class="' + b.sFilterInput + '"/> ', j = e.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, b = h("<div/>", {
                ...
                }, g = null !== a.searchDelay ? a.searchDelay : "ssp" === B(a) ? 400 : 0, i = h("input", b).val(d.sSearch).attr("teste", e.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", g ? ua(f, g) : f).bind("keypress.DT", function (a) {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Mostrando de _START_ a _END_ entradas do total de _TOTAL_ ",
